...
validate_recipe_outputs "aws-parallelcluster-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="aws-parallelcluster-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi